...
def scale_to_percentage(distance, min_distance=5.1, max_distance=14.4):
        ...
        if results.multi_face_landmarks:
            ...
            with mp_face_mesh.FaceMesh(
                ...
                if face_mesh_results.multi_face_landmarks:
                    ...
                    porcentaje_derecho_bruto = scale_to_percentage(AperturaOjoD)
                    porcentaje_izquierdo_bruto = scale_to_percentage(AperturaOjoI)
